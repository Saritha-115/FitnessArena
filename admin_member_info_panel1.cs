...
{
    public partial class admin_member_info_panel1 : Form
    {
        public admin_member_info_panel1()
        {
            InitializeComponent();
        }
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cmd = new SqlCommand("delete from Registration where Client_id = '" + Convert.ToInt32(txt_enter_id.Text) + "'", con);
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cmd = new SqlCommand("update Registration set First_name= '" + txt_fname.Text + "',Last_name='" + txt_lname.Text + "',Age = '" +Convert.ToInt32(txt_age.Text)  + "',Client_add='" + txt_address.Text + "',Telephone='" + Convert.ToInt32(txt_tp.Text) + "',Email='" + txt_email.Text + "' where Client_id = '" + Convert.ToInt32(txt_enter_id.Text) + "'", con);
                    int i = cmd.ExecuteNonQuery();
                    if (i == 1)
                    {
                        MessageBox.Show(this, "Data Update Successfully", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public void read()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Registration where Client_id = '" + Convert.ToInt32(txt_enter_id.Text) + "'", con);
        ...
        private void admin_member_info_panel1_Load(object sender, EventArgs e)
        {
            txt_age.Enabled = false;
        }
    }
