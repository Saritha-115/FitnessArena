...
{
    public partial class admin_registration : MetroFramework.Forms.MetroForm
    {
        ...
        public void GetCustomerId()
        {
            ...
            string custid;
            string custdetails = "select Client_id from Admin_tbl order by Client_id Desc";
        ...
        private void btn_reg_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lbl_error.Text = "Confirm Password must same as the Password";
                    txt_cpw.Focus();
                }
                else
                {
                    if (txt_admin_key.Text == "FA741258")
                    {
                        ...
                        cmd = new SqlCommand("Insert into Admin_tbl Values ('" + txt_fname.Text + "','" + txt_lname.Text + "','" + dateTimePicker_dob.Value + "','" + txt_age.Text + "','" + txt_address.Text + "','" + txt_tp.Text + "','" + txt_email.Text + "','" + dateTimePicker_dob.Value + "','" + txt_pw.Text + "','" + txt_cpw.Text + "')", con);
        ...
        private void txt_admin_key_TextChanged(object sender, EventArgs e)
        {
